...
struct News{
    var id = UUID()
    var imagenews: String //a imagem da notícia
    var title: String //título
    var date: String //mes e dia
    var content: String //a notícia em si
    
}

//notícias que foram pegas da época que estava acontecendo o lolla
var news: [News] = [
